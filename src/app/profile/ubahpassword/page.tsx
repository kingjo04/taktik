            ...
            <div key={field.id} className="mb-6">
              ...
              <div className="relative mt-1">
                <input
                  ...
                  className="w-full rounded-lg border border-gray-200 shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 p-3 text-sm transition-all duration-200 placeholder-gray-400"
                  required
                />
                <button
                  type="button"
                ...
                >
                  <FontAwesomeIcon icon={field.id === "old_password" ? (showOldPassword ? faEyeSlash : faEye) : field.id === "new_password" ? (showNewPassword ? faEyeSlash : faEye) : showConfirmPassword ? faEyeSlash : faEye} className="text-lg" />
                </button>
              </div>
            </div>
          ))}
