...
export default function DetailTryout() {
  ...
  const fetchTryoutDetail = async () => {
    ...
    try {
      ...
      const enhancedData = {
        ...data,
        category: "UTBK", // Placeholder
        exam_category: "Kemampuan Penalaran Umum", // Placeholder
        is_free: true, // Placeholder
        total_question: 5, // Placeholder
        ...
        <div className="flex justify-center my-8">
          <div className="w-full max-w-[1000px] bg-gradient-to-br from-blue-700 to-blue-900 rounded-2xl p-6 sm:p-8 shadow-lg hover:shadow-xl transition-all duration-300">
            ...
            <div className="mt-8 flex flex-col sm:flex-row justify-center gap-4">
              <button
                className="w-full sm:w-[240px] h-14 bg-white text-blue-700 text-xl font-semibold rounded-2xl hover:bg-gray-100 transition-all duration-300 transform hover:scale-105"
